...
from src.models.schemes.gen_schemes.AssetRequest import AssetRequest
...
async def upload_file(
    ...
    if not is_valid:
        return JSONResponse(
            ...
            content={"is_valid": is_valid, "message": message},
        )
...
async def process_file(
    ...
    chunk_overlap = asset_request.chunk_overlap
    do_reset = asset_request.do_reset
    ...
    (
        ...
        no_files_processed,
        no_files_chunked,
    ) = await request_controller.handle_asset_processing(
        project_title,
        asset_id,
        chunk_size,
        chunk_overlap,
